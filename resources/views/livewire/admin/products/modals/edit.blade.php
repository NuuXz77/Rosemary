        ...
        <fieldset class="mt-4">
            ...
            @if($existing_foto)
                <div class="mb-2 flex items-center gap-3">
                    <div class="avatar">
                        <div class="w-14 h-14 rounded-xl border border-base-300 overflow-hidden">
                            <img src="{{ Storage::url($existing_foto) }}" alt="Foto saat ini" class="object-cover w-full h-full" />
                        </div>
                    </div>
                    <span class="text-xs text-base-content/50">Foto saat ini. Upload baru untuk mengganti.</span>
                </div>
            @endif

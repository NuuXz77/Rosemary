<div>
    <div class="card bg-base-100 border border-base-300">
        <div class="card-body">
            <div class="flex items-center justify-between mb-4">
                <div class="w-full md:w-auto">
                    <label class="input input-sm">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari produk untuk laporan stok..." />
                    </label>
                </div>
                <div>
            ...
            <x-partials.table :columns="[['label'=>'No','class'=>'w-12'], ['label'=>'Produk'], ['label'=>'Qty'], ['label'=>'Unit'], ['label'=>'Terakhir Update']]" :data="$stocks" emptyMessage="Tidak ada data stok untuk laporan">

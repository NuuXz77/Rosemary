<div>
    <x-form.modal
        modalId="adjust-material-modal"
        :title="'Penyesuaian Stok: ' . $materialName"
    ...
    >
        <div class="flex flex-col gap-4">
                ...
                <div class="flex gap-3">
                    ...
                    <label class="label cursor-pointer flex gap-3 bg-error/10 p-3 rounded-lg border border-error/20 w-full">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-[10px] opacity-60">Rusak / Hilang / adjustment -</span>
                        </div>
                    </label>
                </div>
            </fieldset>
            ...
            <x-form.input
                ...
                step="0.001"
            >
                <span class="text-sm font-medium opacity-50 pr-1">unit</span>
            </x-form.input>

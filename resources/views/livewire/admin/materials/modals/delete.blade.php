    ...
    >
        <div class="flex flex-col items-center text-center py-4">
            ...
            <p class="text-base-content/60 mt-1 max-w-sm">
                Data material <span class="font-semibold text-base-content">{{ $materialName }}</span> akan dihapus permanen.
                Pastikan material tidak lagi digunakan dalam resep atau memiliki riwayat stok.
            </p>
        </div>
    </x-form.modal>
</div>

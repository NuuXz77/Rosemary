<div>
    <div class="space-y-6">
        ...
        <div class="alert alert-info alert-soft">
            ...
            <span class="text-sm">Informasi penting: nama role sebaiknya lowercase tanpa spasi (contoh: <strong>inventory_manager</strong>) supaya konsisten untuk user guide dan audit akses.</span>
        </div>
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row gap-2 justify-end pt-2 border-t border-base-300">
                <a wire:navigate href="{{ route('roles.index') }}" class="btn btn-ghost">Batal</a>

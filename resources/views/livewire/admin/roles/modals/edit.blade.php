<x-form.modal
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="grid grid-cols-1 gap-4">
            {{-- NAMA ROLE --}}
            <x-form.input label="Nama Role" name="name" icon="heroicon-o-shield-check"
                placeholder="Contoh: admin, guru, siswa" wireModel="name" :required="true" maxlength="50"
                validatorMessage="Nama role wajib diisi"
                hint="Nama role harus unik dan lowercase (tanpa spasi)" />

            {{-- GUARD NAME --}}
            <x-form.input label="Guard Name" name="guard_name" icon="heroicon-o-lock-closed" placeholder="web"
                wireModel="guard_name" :required="true" maxlength="50"
                validatorMessage="Guard name wajib diisi" hint="Default: web (untuk autentikasi web biasa)" />
            ...
            <fieldset>
                ...
                <label
                    ...
                    <textarea wire:model="description" placeholder="Deskripsi singkat tentang role ini..." rows="3" maxlength="255"
                        class="grow"></textarea>
                </label>
                @error('description')

<div>
    <div class="card bg-base-100 border border-base-300">
        <div class="card-body">
            ...
            <x-partials.table :columns="[['label'=>'No','class'=>'w-12'], ['label'=>'Produk'], ['label'=>'Qty'], ['label'=>'Unit'], ['label'=>'Terakhir Update'], ['label'=>'Aksi','class'=>'text-center']]" :data="$stocks" emptyMessage="Tidak ada stok produk">
                @foreach($stocks as $i => $stock)
                    <tr wire:key="pstock-{{ $stock->id }}" class="hover:bg-base-200">

                        ...
                        <div class="alert alert-soft alert-info">
                            ...
                            <div class="text-sm">
                                ...
                                <ul class="list-disc list-inside space-y-1">
                                    <li><strong>Kolom A (Nama Satuan):</strong> nama satuan, contoh: kg, pcs, liter (wajib)</li>
                                    <li><strong>Kolom B (Status):</strong> active atau inactive (opsional, default: active)</li>
                                </ul>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex flex-col items-center justify-center p-6 border-2 border-dashed border-base-300 rounded-lg bg-base-200/50 hover:bg-base-200 transition-colors h-full min-h-[200px]">
                            ...
                            @else
                                ...
                                <label for="file-upload-units" class="btn btn-primary btn-sm gap-2 cursor-pointer">
                                    <x-heroicon-o-folder-open class="w-4 h-4" />
                                    Pilih File
                                </label>
                                <input id="file-upload-units" type="file" wire:model="file" accept=".xlsx,.xls" class="hidden" />
                            @endif
                ...
                <table class="table table-zebra table-sm">
                    ...
                    <tbody>
                                ...
                                <tr class="hover:bg-base-200 {{ isset($row['has_error']) && $row['has_error'] ? 'bg-error/10' : '' }}">
                                    ...
                                    <td>
                                        <input
                                            ...
                                            class="input input-xs input-bordered w-full uppercase"
                        ...
                        @elseif (is_array($previewData) && count($previewData) > 0)
                            <tr>
                                <td colspan="{{ count($availableSheets) > 1 ? 6 : 5 }}" class="text-center py-10">
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-12">
                                    <div class="flex flex-col items-center gap-3 text-gray-400">
                                        ...
                                        <p class="text-sm">Upload file Excel untuk melihat data satuan</p>
                                    </div>
                                </td>
                            </tr>
                        @endif

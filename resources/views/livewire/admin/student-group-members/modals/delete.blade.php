    ...
    <div class="flex flex-col items-center text-center gap-4 py-4">
        ...
        <div>
            ...
            <p class="text-sm opacity-70">
                Anda akan menghapus siswa <span class="font-bold text-error">'{{ $studentName }}'</span> 
                dari kelompok <span class="font-bold text-error">'{{ $groupName }}'</span>.

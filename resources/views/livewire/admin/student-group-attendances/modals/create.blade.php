<x-form.modal
    modalId="modal_create_student_group_attendance"
    title="Tambah Kehadiran Grup"
    buttonText="Tambah Kehadiran Grup"
    ...
    @if($schedules->isEmpty())
        <div class="alert alert-info text-sm">
            ...
            <span>Tidak ada jadwal produksi grup yang tersedia untuk dibuatkan kehadiran.</span>
        </div>
    @else
        <x-form.select

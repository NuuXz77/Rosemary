<div>
    <x-form.modal
        modalId="create-guide-faq-modal"
        title="Tambah FAQ Guide"
    ...
    >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <x-form.input label="Pertanyaan" name="title" wireModel="title" placeholder="Contoh: Menu tidak muncul?" size="input-sm" required />
            ...
            <x-form.input label="Jawaban" name="body" wireModel="body" placeholder="Isi jawaban FAQ" size="input-sm" containerClass="md:col-span-2" required />
        </div>

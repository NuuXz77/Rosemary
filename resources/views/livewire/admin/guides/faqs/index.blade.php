<div class="space-y-6">
    ...
    <div class="card bg-base-100 border border-base-300">
        <div class="card-body p-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                <div class="flex items-center gap-2 w-full md:w-auto">
                    <label class="input input-sm input-bordered flex items-center gap-2 w-full md:w-80">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" class="grow" placeholder="Cari FAQ guide..." />
                    </label>
                ...
                <livewire:admin.guides.faqs.modals.create :active-role="$activeRole" :key="'guide-faq-create-' . $activeRole" />
            </div>
            ...
            <x-partials.table :columns="$columns" :data="$rows" emptyMessage="Belum ada FAQ guide.">
                @foreach ($rows as $index => $row)
                    <tr wire:key="faq-{{ $row->id }}" class="hover:bg-base-200/40 transition-colors">
    ...
    <livewire:admin.guides.faqs.modals.edit />
    <livewire:admin.guides.faqs.modals.delete />
</div>

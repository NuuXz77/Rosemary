...
return new class extends Migration
{
    ...
    {
        Schema::create('student_group_attendances', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['student_group_id', 'schedule_id']);
            $table->index('date');
            $table->index('status');
        });
    }
    ...
    {
        Schema::dropIfExists('student_group_attendances');
    }
};
